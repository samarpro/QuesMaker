...
# this code manipulates the question - Long Question
...
# actNoPara = (noPara//5)*5 not needed 
# print(noPara//5,actNoPara)
# letters = ["A","B","C","D","E"] not needed 
...
# randomizes the option not needed
...
ques_pos_list = random.sample(range(0, actNoPara),n)
print(ques_pos_list)
